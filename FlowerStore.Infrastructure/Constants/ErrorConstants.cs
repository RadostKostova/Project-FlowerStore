namespace FlowerStore.Infrastructure.Constants
{
    ...
    public static class ErrorConstants
    {
        ...
        public const string CardCVVErrorMessage = "The {0} code should be exactly 3 numbers.";
        public const string CardNumberErrorMessage = "The {0} field should be exactly 16 numbers.";
    }
}
