...
namespace FlowerStore.Infrastructure.Migrations
{
    ...
    [Migration("20241128124117_AddReviewEntity")]
            ...
            modelBuilder.Entity("FlowerStore.Infrastructure.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Availability = true,
                            CategoryId = 6,
                            DateAdded = new DateTime(2024, 11, 28, 12, 41, 17, 396, DateTimeKind.Utc).AddTicks(2519),
                            FlowersCount = 5,
                        ...
                        new
                        {
                            ...
                            Availability = true,
                            CategoryId = 7,
                            DateAdded = new DateTime(2024, 11, 28, 12, 41, 17, 396, DateTimeKind.Utc).AddTicks(2520),
                            FlowersCount = 7,
                        ...
                        new
                        {
                            ...
                            Availability = true,
                            CategoryId = 7,
                            DateAdded = new DateTime(2024, 11, 28, 12, 41, 17, 396, DateTimeKind.Utc).AddTicks(2521),
                            FlowersCount = 4,
                        ...
                        new
                        {
                            ...
                            Availability = true,
                            CategoryId = 6,
                            DateAdded = new DateTime(2024, 11, 28, 12, 41, 17, 396, DateTimeKind.Utc).AddTicks(2522),
                            FlowersCount = 10,
                        ...
                        new
                        {
                            ...
                            Availability = true,
                            CategoryId = 6,
                            DateAdded = new DateTime(2024, 11, 28, 12, 41, 17, 396, DateTimeKind.Utc).AddTicks(2523),
                            FlowersCount = 10,
                            FullDescription = "Begonias are a diverse genus of flowering plants in the family Begoniaceae, encompassing over 2,000 species. They are prized for their vibrant flowers, striking foliage, and adaptability to various growing conditions. Native to tropical and subtropical regions worldwide, begonias are cultivated extensively as ornamental plants. They produce showy flowers in a range of colors, including red, pink, white, and orange. The blooms are often asymmetrical and can vary significantly in size depending on the variety.",
                        ...
                        new
                        {
                            ...
                            Availability = true,
                            CategoryId = 6,
                            DateAdded = new DateTime(2024, 11, 28, 12, 41, 17, 396, DateTimeKind.Utc).AddTicks(2524),
                            FlowersCount = 8,
                        ...
                        new
                        {
                            ...
                            Availability = true,
                            CategoryId = 6,
                            DateAdded = new DateTime(2024, 11, 28, 12, 41, 17, 396, DateTimeKind.Utc).AddTicks(2525),
                            FlowersCount = 6,
                        ...
                        new
                        {
                            ...
                            Availability = true,
                            CategoryId = 4,
                            DateAdded = new DateTime(2024, 11, 28, 12, 41, 17, 396, DateTimeKind.Utc).AddTicks(2526),
                            FlowersCount = 14,
                        ...
                        new
                        {
                            ...
                            Availability = true,
                            CategoryId = 6,
                            DateAdded = new DateTime(2024, 11, 28, 12, 41, 17, 396, DateTimeKind.Utc).AddTicks(2527),
                            FlowersCount = 4,
                        ...
                        new
                        {
                            ...
                            Availability = true,
                            CategoryId = 1,
                            DateAdded = new DateTime(2024, 11, 28, 12, 41, 17, 396, DateTimeKind.Utc).AddTicks(2528),
                            FlowersCount = 3,
            ...
            modelBuilder.Entity("FlowerStore.Infrastructure.Data.Models.Roles.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "adminId",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e8783192-16f4-4820-9239-201f064f6cab",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAELGjroEYIM+6c8SntS1i4BoWfOGKEwN5zIVkmJafeF2PXvLNU2eh2d2lS7Rp1v4kwA==",
                            Phone = "1234567890",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "d3207cab-ff7c-4954-b122-70be22a258b3",
                        ...
                        new
                        {
                            Id = "testId",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8d0898a3-74c2-404e-a058-fd7f40a0cbc5",
                            Email = "test@test.com",
                            EmailConfirmed = false,
                            FirstName = "Test",
                            LastName = "Test",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEH3We/klgP62XKrXBNJJXEtwh4e/vJzXd/7KjNJwZn9UvOHUUvPRod5Si+ZJEo5adA==",
                            Phone = "1234567800",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "31121064-d83e-45cf-a482-91c257407f04",
                            TwoFactorEnabled = false,
